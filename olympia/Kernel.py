    ...
    def runner(
        ...
        for sim in range(num_simulations):
            ...
            eventQueueWallClockElapsed = (
                eventQueueWallClockStop - eventQueueWallClockStart
            )
